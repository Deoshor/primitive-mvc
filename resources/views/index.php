        ...
        foreach ($topic as $item) {
            ...
            if (isset($_SESSION['email']) && $_SESSION['id'] == $item['topic2user']) {
                echo '<div class="col-1">
                            <a class="link-dark" href="#topicEditModal" data-bs-toggle="modal" data-bs-target=#topicEditModal>
                ...
                echo '<div class="col-1">
                            <a class="link-dark" href="#topicDeleteModal" data-bs-toggle="modal" data-bs-target=#topicDeleteModal>
                ...
                echo '<div class="modal fade" id="topicEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Заголовок темы</h5>
                                ...
                                <div class="container">
                                    <form action="/topic/update" method="POST">
                                        <div class="mb-3 mt-3">
                                            ...
                                            <input type="hidden" name="id" class="form-control" id="topic_id" value="' . $item['id'] . '">
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Закрыть</button>
                ...
                echo '<div class="modal fade" id="topicDeleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
