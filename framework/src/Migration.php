...
class Migration
{
    ...
    public function createTable()
    {
        ...
        CREATE TABLE IF NOT EXISTS forum.article_files
        (
            id SERIAL PRIMARY KEY,
            article_filename varchar(255),
            file2article INT REFERENCES forum.articles (id)   
        );
        ...
        CREATE TABLE IF NOT EXISTS forum.comment_files
        (
            id SERIAL PRIMARY KEY,
    ...
    public function insertIntoTables()
    {
        $sql = "INSERT INTO forum.users(name, lastname, email, password)
            ...
            INSERT INTO forum.comments(comment, comment2user, comment2article, last_update_date)
	        VALUES 
            ('Тойота лучший автопроизводитель мира! Владельцы остальных автомобилей:', 1, 1, '2022-11-12 11:30'),
            ('Хонда делает самые быстрые гражданские (и не только) авто!', 1, 2, '2022-11-12 17:28'),
            ('Nissan с технологией E-power ушли очень далеко от остальных автокомпаний!)', 1 , 3, '2022-11-12 21:16');
            COMMIT;

            INSERT INTO forum.comment_files(comment_filename, file2comment)
	        VALUES 
            ('palka-768x359.jpg', 1),
            ('palka1-768x359.jpg', 1),
            (null, 2),
            (null , 3);
            COMMIT;
            ";
