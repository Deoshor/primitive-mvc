            ...
            <div class="modal-content">
                ...
                <div class="container">
                    <form action="/article/update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 mt-3">
                            <textarea type="text" name="article_description" class="form-control" id="article_description"><?php echo $article['article_description']; ?></textarea>
        ...
        foreach ($comments_data as $item) {
            echo '<div class="container w-75 border border-light rounded bg-secondary bg-gradient mt-1" style="--bs-bg-opacity: .1">
                    <div class="row mt-1 mb-1">
                        ...
                        if (isset($_SESSION['email']) && $_SESSION['id'] == $item['comment2user']) {
                            echo '<a class="link-dark" href="#commentEditModal" data-bs-toggle="modal" data-bs-target=#commentEditModal>
                    ...
                    echo '</div>
                        <div class="col-1">';
                        if (isset($_SESSION['email']) && $_SESSION['id'] == $item['comment2user']) {
                            echo '<a class="link-dark" href="#commentDeleteModal" data-bs-toggle="modal" data-bs-target=#commentDeleteModal>
            ...
            echo '<div class="modal fade" id="commentDeleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
            ...
            echo '<div class="modal fade" id="commentEditModal" tabindex="-1" aria-labelledby="articleModal" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="container">
                                <form action="/comment/update" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3 mt-3">
                                        <textarea type="text" name="comment" class="form-control" id="comment">' . $item['comment'] . '</textarea>
                                        <div class="form-text">Редактируйте сам комментарий к статье</div>
                                    </div>
                                    <div class="mb-3 mt-3">
